...
class Arabalar extends StatefulWidget {
  const Arabalar({Key? key}) : super(key: key);
...
class _ArabalarState extends State<Arabalar> {
  ...
  fetchApi() async {
    await http.get(
        Uri.parse("https://api.pexels.com/v1/search?query=cars&per_page=80"),
        headers: {
          'Authorization':
  ...
  devamEt() async {
    ...
    String url =
        "https://api.pexels.com/v1/search?query=cars&per_page=80&page=$sayfa";
